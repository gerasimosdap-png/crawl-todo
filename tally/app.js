...
function defaultState() {
  return {
    version: 1,
    tasks: [],
    settings: { theme: 'sage', notify: false, reminderTime: '20:00', name: '', lastNotifyDay: '', gcalConnected: false, gcalShow: true, gcalClientId: '', celebratedWeek: '' },
    onboarded: false,
    createdAt: Date.now(),
    updatedAt: Date.now()
  };
...
function save() { S.updatedAt = Date.now(); try { localStorage.setItem(STORE_KEY, JSON.stringify(S)); } catch (e) {} }
