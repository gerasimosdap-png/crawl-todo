...
function openEditor(id) {
  ...
  if (S.settings.aiEnabled) {
    const cl = el('button', 'btn ghost', '✨ Sharpen with AI'); cl.id = 'ef-clarify'; cl.type = 'button'; cl.style.marginTop = '8px';
    cl.addEventListener('click', aiClarify);
    fTitle.appendChild(cl);
  }
